...
import com.example.myclub.googlemap.DirectionsJSONParser;
import com.example.myclub.R;
import com.example.myclub.googlemap.models.Location;
...
public class PlaceOnMapActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private String getDirectionsUrl(LatLng origin, LatLng dest) {
        ...
        String parameters = str_origin + "&" + str_dest + "&" + sensor + "&key=" + this.getResources().getString(R.string.google_map_api_key);
