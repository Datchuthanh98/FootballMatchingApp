...
import com.example.myclub.databinding.FragmentEditPlayerPasswordBinding;
...
public class FragmentPassword extends BottomSheetDialogFragment {
    private FragmentEditPlayerPasswordBinding binding;
    private SessionUser session = SessionUser.getInstance();
    private    Map<String, Object> data = new HashMap<>();
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = FragmentEditPlayerPasswordBinding.inflate(inflater);
