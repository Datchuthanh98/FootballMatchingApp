...
import com.example.myclub.adapter.AdapterFragmentField;
...
public class MainFieldActivity extends AppCompatActivity {
...
//    private SyncFireBase syncFireBase = SyncFireBase.getInstance();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        setContentView(R.layout.main_field_activity);
