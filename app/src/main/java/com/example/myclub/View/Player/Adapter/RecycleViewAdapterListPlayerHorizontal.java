...
import com.example.myclub.View.Player.Activity.ActivityInformationPlayer;
...
public class RecycleViewAdapterListPlayerHorizontal extends RecyclerView.Adapter<RecycleViewAdapterListPlayerHorizontal.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.item_player_horizontal, parent, false);
...
//        }
       ...
       holder.namePlayer.setText("Hazard");
       holder.position.setText("LM");
