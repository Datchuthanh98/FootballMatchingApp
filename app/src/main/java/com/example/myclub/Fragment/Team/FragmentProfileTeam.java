package com.example.myclub.Fragment.Team;
...
import com.example.myclub.Adapter.Player.RecycleViewAdapterListPlayerHorizontal;
...
public class FragmentProfileTeam extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_profile_team,container,false);
    }
